...
return new class extends Migration
{
    ...
    {
        Schema::create('cust_products', function (Blueprint $table) {
            $table->id('cust_product_id')->primary();
            $table->integer('cust_product_user_id')->default(0);
    ...
    {
        Schema::dropIfExists('cust_products');
    }
};
